                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-5b63ea3366c6686757cc965aef52f2f1"' : 'data-target="#xs-components-links-module-AppModule-5b63ea3366c6686757cc965aef52f2f1"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-5b63ea3366c6686757cc965aef52f2f1"' :
                                            'id="xs-components-links-module-AppModule-5b63ea3366c6686757cc965aef52f2f1"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/DashboardPageModule.html" data-type="entity-link">DashboardPageModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-DashboardPageModule-cea5756dc174ead507a277b50b3e3cea"' : 'data-target="#xs-components-links-module-DashboardPageModule-cea5756dc174ead507a277b50b3e3cea"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-DashboardPageModule-cea5756dc174ead507a277b50b3e3cea"' :
                                            'id="xs-components-links-module-DashboardPageModule-cea5756dc174ead507a277b50b3e3cea"' }>
                                            <li class="link">
